  ...
  return (
    <div className={`${dark ? 'bg-darkBg' : 'bg-lightBg'} w-full h-fit transition-all duration-100 py-[2.5rem]`}>
        ...
        <div className='w-[90%] mx-auto flex flex-col md:flex-row md:items-center justify-between gap-3 md:gap-0'>
            ...
            {/* search */}
            <div className={`${dark? 'bg-darkElements' : 'bg-darkModeTextLightElements'} w-full md:w-[40%] px-[2rem] py-[1rem] rounded-md shadow-md flex items-center gap-4`}>
            ...
            {/* dropdown */}
            <select className={`drop-down    ${dark? 'bg-darkElements' : 'bg-darkModeTextLightElements'} w-fit  px-[2rem] py-[1rem] rounded-md shadow-md flex items-center focus: outline-none mb-[10px] transition-all duration-100 `} name="selectValue" onChange={handleDropDownChange}>
        ...
        {/*  cards container */}
        <div className='cards-container w-[90%] grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-10 md:gap-20  mx-auto mt-[2.5rem]'>
            {
